...
Client_ID = "h9vxM0sNfULmuHB3rMsV"
Client_Secret = "yOOCLgPJdT"

# 검색하고자 하는 키워드가 한글인 경우 UTF-8로 인코딩 변환 필요
...
nouns.df.sortdec = nouns.df[order(-nouns.df$Freq),]
nouns.df.sortdec
